    ...
    <header class="text-white body-font bg-gradient-to-t from-[#006470] to-cyan-400">
      <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <button href="{{route('sign_up')}}"
              class="inline-flex transition translate-x-8 duration-300 hover:scale-110 rounded-md items-center bg-transparent border-2 border-white shadow-sm shadow-black font-bold py-1 px-3 hover:bg-gradient-to-r hover:from-cyan-400 hover:via-cyan-500 hover:to-blue-400 focus:outline-none text-base mt-4 md:mt-0">Sign
              Up
          </button>
      </div>
  </header>
